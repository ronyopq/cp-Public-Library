...
/**
 * This script seeds the database with initial roles, permissions, and reference data.
...
('perm_books_import', 'books:import', 'books', 'Bulk import books', 1),
('perm_copies_read', 'copies:read', 'books', 'View book copies', 1),
('perm_copies_create', 'copies:create', 'books', 'Register physical copies', 1),
('perm_copies_update', 'copies:update', 'books', 'Update copy condition', 1),
('perm_copies_delete', 'copies:delete', 'books', 'Soft-delete copies', 1),
...
('perm_loans_export', 'loans:export', 'loans', 'Export loan data', 1),
...
('perm_members_suspend', 'members:suspend', 'members', 'Suspend member', 1),
('perm_members_import', 'members:import', 'members', 'Bulk import members', 1),
('perm_fines_read', 'fines:read', 'fines', 'View fines', 1),
('perm_fines_create', 'fines:create', 'fines', 'Record a fine', 1),
('perm_fines_waive', 'fines:waive', 'fines', 'Waive/forgive fine', 1),
...
('perm_receipts_print', 'receipts:print', 'fines', 'Print payment receipts', 1),
('perm_print_read', 'print:read', 'print', 'View print templates', 1),
('perm_print_barcodes', 'print:barcodes', 'print', 'Print barcodes', 1),
('perm_print_id_cards', 'print:id_cards', 'print', 'Print ID cards', 1),
('perm_print_reports', 'print:reports', 'print', 'Print reports', 1),
('perm_competitions_read', 'competitions:read', 'competitions', 'View competitions', 1),
('perm_competitions_create', 'competitions:create', 'competitions', 'Create competition', 1),
('perm_competitions_manage', 'competitions:manage', 'competitions', 'Manage registrations', 1),
('perm_reports_read', 'reports:read', 'reports', 'View dashboards', 1),
('perm_reports_export', 'reports:export', 'reports', 'Export data', 1),
('perm_reports_financials', 'reports:financials', 'reports', 'View financial ledgers', 1),
('perm_admin_settings', 'admin:settings', 'admin', 'Configure settings', 1),
('perm_admin_flags', 'admin:flags', 'admin', 'Manage feature flags', 1),
('perm_admin_audit', 'admin:audit', 'admin', 'View audit logs', 1),
('perm_admin_users', 'admin:users', 'admin', 'Manage staff users', 1),
('perm_admin_backup', 'admin:backup', 'admin', 'Backup/restore data', 1);
...
('role_librarian', 'perm_receipts_print'),
('role_librarian', 'perm_print_barcodes'),
('role_librarian', 'perm_print_id_cards'),
('role_librarian', 'perm_reports_read');

-- Officer: more permissions
INSERT INTO role_permissions (role_id, permission_id) VALUES
('role_officer', 'perm_books_read'),
('role_officer', 'perm_books_create'),
('role_officer', 'perm_books_update'),
('role_officer', 'perm_books_import'),
('role_officer', 'perm_copies_read'),
('role_officer', 'perm_copies_create'),
('role_officer', 'perm_copies_update'),
('role_officer', 'perm_loans_read'),
('role_officer', 'perm_loans_create'),
('role_officer', 'perm_loans_return'),
('role_officer', 'perm_loans_renew'),
('role_officer', 'perm_loans_export'),
('role_officer', 'perm_members_read'),
('role_officer', 'perm_members_create'),
('role_officer', 'perm_members_update'),
('role_officer', 'perm_members_suspend'),
('role_officer', 'perm_members_import'),
...
('role_officer', 'perm_receipts_print'),
('role_officer', 'perm_print_read'),
('role_officer', 'perm_print_barcodes'),
('role_officer', 'perm_print_id_cards'),
('role_officer', 'perm_print_reports'),
('role_officer', 'perm_reports_read'),
('role_officer', 'perm_reports_export'),
('role_officer', 'perm_competitions_read'),
('role_officer', 'perm_competitions_create');
...
('role_manager', 'perm_books_import'),
('role_manager', 'perm_copies_read'),
('role_manager', 'perm_copies_create'),
('role_manager', 'perm_copies_update'),
('role_manager', 'perm_copies_delete'),
('role_manager', 'perm_loans_read'),
('role_manager', 'perm_loans_create'),
('role_manager', 'perm_loans_return'),
('role_manager', 'perm_loans_renew'),
('role_manager', 'perm_loans_export'),
...
('role_manager', 'perm_members_suspend'),
('role_manager', 'perm_members_import'),
('role_manager', 'perm_fines_read'),
('role_manager', 'perm_fines_create'),
('role_manager', 'perm_fines_waive'),
('role_manager', 'perm_payments_read'),
('role_manager', 'perm_payments_create'),
('role_manager', 'perm_receipts_print'),
('role_manager', 'perm_print_read'),
('role_manager', 'perm_print_barcodes'),
('role_manager', 'perm_print_id_cards'),
('role_manager', 'perm_print_reports'),
('role_manager', 'perm_reports_read'),
('role_manager', 'perm_reports_export'),
('role_manager', 'perm_reports_financials'),
('role_manager', 'perm_competitions_read'),
('role_manager', 'perm_competitions_create'),
('role_manager', 'perm_competitions_manage'),
('role_manager', 'perm_admin_settings'),
('role_manager', 'perm_admin_flags');
...
('role_admin', 'perm_books_import'),
('role_admin', 'perm_copies_read'),
('role_admin', 'perm_copies_create'),
('role_admin', 'perm_copies_update'),
('role_admin', 'perm_copies_delete'),
('role_admin', 'perm_loans_read'),
('role_admin', 'perm_loans_create'),
('role_admin', 'perm_loans_return'),
('role_admin', 'perm_loans_renew'),
('role_admin', 'perm_loans_export'),
('role_admin', 'perm_members_read'),
('role_admin', 'perm_members_create'),
('role_admin', 'perm_members_update'),
('role_admin', 'perm_members_delete'),
('role_admin', 'perm_members_suspend'),
('role_admin', 'perm_members_import'),
('role_admin', 'perm_fines_read'),
('role_admin', 'perm_fines_create'),
('role_admin', 'perm_fines_waive'),
('role_admin', 'perm_payments_read'),
('role_admin', 'perm_payments_create'),
('role_admin', 'perm_receipts_print'),
('role_admin', 'perm_print_read'),
('role_admin', 'perm_print_barcodes'),
('role_admin', 'perm_print_id_cards'),
('role_admin', 'perm_print_reports'),
('role_admin', 'perm_reports_read'),
('role_admin', 'perm_reports_export'),
('role_admin', 'perm_reports_financials'),
('role_admin', 'perm_competitions_read'),
('role_admin', 'perm_competitions_create'),
('role_admin', 'perm_competitions_manage'),
('role_admin', 'perm_admin_settings'),
('role_admin', 'perm_admin_flags'),
...
console.log('✅ Seed data prepared. Run: wrangler d1 execute library-dev --file scripts/seed.sql');
console.log('\n' + seed_sql);
